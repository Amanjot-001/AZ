...
import { BellLogo, MenuLogo } from "../../../assets";

const Header: React.FC = () => {
return (
		<header className="flex items-center justify-between p-4 bg-white shadow-md">
			<div className="flex items-center">
				<img src={MenuLogo} alt="menu" className="mr-2 w-6 h-6" />
				<span className="text-xl font-bold text-gray-800">AlgoZenith</span>
			</div>

			<div className="flex items-center">
				<img src={BellLogo} alt="notification" className="mr-4 w-6 h-6 cursor-pointer" />
